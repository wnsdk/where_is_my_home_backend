...
<jsp:include page="/include/head.jsp" flush="true"></jsp:include>
  ...
  <div class="container">
    ...
    <div class="mt-3 text-center col-md-12 mb-3">
      <h3>아파트 실거래가 조회</h3>
    ...
    <div class="row">
      <div id="tablediv" class="col-md-5">
        <script type="text/javascript"
          src="//dapi.kakao.com/v2/maps/sdk.js?appkey=892d495e179cd940ef03591ce36ec983&libraries=services,clusterer"></script>
...
<%@ include file="/include/footer.jsp" %>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"
    ...
    <script src="assets/js/aptprice.js"></script>
</body>
